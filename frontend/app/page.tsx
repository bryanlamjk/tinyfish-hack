		...
		try {
			response = await fetch(`${API_BASE_URL}/api/searches`, {
				...
				body: JSON.stringify({
					...
					block_marketplace_providers: form.blockMarketplaceProviders,
		...
		<main className="shell">
			<section className="hero">
				<div className="hero-copy">
					...
					<h1>TravellingFish. Search once. See every option.</h1>
					<p className="lede">
				...
				<form className="search-panel" onSubmit={handleSubmit}>
					...
					<div className="field-grid">
						...
						<label className="field checkbox-field">
							...
							<input
								type="checkbox"
								checked={form.blockMarketplaceProviders}
								onChange={(event) =>
									setForm((current) => ({
										...current,
			...
			<section className="results-panel">
				<div className="section-heading">
					<h2>Results</h2>
					<p>
						Deal summaries land here once the concurrent session
						finishes.
					</p>
				</div>
